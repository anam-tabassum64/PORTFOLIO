...
const Certificates = () => {
  ...
  return (
    <section
      id="certificates"
      className="overflow-hidden bg-[#f7f3ed] px-6 py-14 lg:px-24 lg:py-16"
    ...
    >
      <div className="mx-auto max-w-[860px]">
        ...
        <div className="overflow-hidden rounded-[28px] border border-[#eadcc9] bg-[rgba(255,255,255,0.3)] shadow-[0_18px_50px_rgba(108,82,45,0.06)] backdrop-blur-[2px]">
          <ul className="flex flex-col">
            {displayCertificates.map((cert, idx) => (
              ...
              >
                ...
                <div className="relative z-10 grid gap-4 px-5 py-6 sm:grid-cols-[56px_1fr_auto] sm:gap-0 sm:px-6 sm:py-7">
                  <span className="pt-1 font-syne text-[11px] font-bold tracking-[.18em] text-[#c3a06f] transition-colors duration-300 group-hover:text-[#d2b893] group-focus-within:text-[#d2b893]">
                    {String(idx + 1).padStart(2, '0')}
                  </span>

                  <div className="sm:pr-6">
                    <p className="mb-[0.55rem] font-syne text-[9px] font-bold uppercase tracking-[.28em] text-[#b4884b] transition-colors duration-300 group-hover:text-[#d2b893] group-focus-within:text-[#d2b893]">
                      {cert.issuer}
                    </p>
                    <h3 className="mb-2 font-playfair text-[clamp(1.2rem,2.6vw,1.55rem)] font-normal leading-[1.18] tracking-[-0.01em] text-[#6c522d] transition-colors duration-300 group-hover:text-[#f7f3ed] group-focus-within:text-[#f7f3ed]">
                      {cert.title}
                    </h3>
                    <p className="max-w-[52ch] font-mono text-[11px] leading-[1.75] tracking-[.02em] text-[#906d3c] transition-colors duration-300 group-hover:text-[#e1cfb7] group-focus-within:text-[#e1cfb7]">
                      {cert.summary}
                    </p>
                    <div className="mt-3 flex flex-wrap gap-1.5">
                      {cert.skills.map((skill) => (
                        <span
                          key={skill}
                          className="border border-[#e1cfb7] px-2.5 py-1 font-syne text-[9px] font-bold uppercase tracking-[.18em] text-[#906d3c] transition-[color,border-color] duration-300 group-hover:border-[#b4884b] group-hover:text-[#e1cfb7] group-focus-within:border-[#b4884b] group-focus-within:text-[#e1cfb7]"
                        >
                          {skill}
                        </span>
                      ))}
                  ...
                  <div className="flex flex-row items-center justify-between gap-3 pt-1 sm:min-w-16 sm:flex-col sm:items-end sm:justify-start sm:gap-3">
                    <span className="font-syne text-[11px] font-bold tracking-[.2em] text-[#c3a06f] transition-colors duration-300 group-hover:text-[#d2b893] group-focus-within:text-[#d2b893]">
                      {cert.year}
                    </span>
                    {cert.link ? (
                      <a
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-full border border-[#e1cfb7] text-[#6c522d] transition-[transform,background,border-color,color] duration-300 group-hover:-rotate-45 group-hover:border-[#b4884b] group-hover:bg-[#b4884b] group-hover:text-white group-focus-within:-rotate-45 group-focus-within:border-[#b4884b] group-focus-within:bg-[#b4884b] group-focus-within:text-white"
                      >
                        <ArrowUpRight size={14} />
                      </a>
                    ) : (
                      <div className="flex h-9 w-9 items-center justify-center rounded-full border border-[#e1cfb7] text-[#c3a06f] transition-[transform,border-color,color] duration-300 group-hover:-rotate-45 group-hover:border-[#b4884b] group-hover:text-[#e1cfb7] group-focus-within:-rotate-45 group-focus-within:border-[#b4884b] group-focus-within:text-[#e1cfb7]">
                        <Award
                          size={14}
          ...
          <div className="flex flex-col gap-3 border-t border-[#e1cfb7] px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            <span className="font-syne text-[9px] font-bold uppercase tracking-[.3em] text-[#c3a06f]">
          ...
          {certificates.length === 0 ? (
            <p className="px-5 pb-4 text-center font-mono text-[11px] tracking-[.08em] text-[#b4884b] sm:px-6">
