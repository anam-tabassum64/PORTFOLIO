...
import emotionScopeImage from '@/content/projects/emotionscope.svg';
import evAdoptionImage from '@/content/projects/ev-adoption.svg';
import crimePatternsImage from '@/content/projects/crime-patterns.svg';
...
const projectImageMap: Record<string, string> = {
  EmotionScope: emotionScopeImage,
  'EV Adoption Analysis Dashboard': evAdoptionImage,
  'Crime Patterns Across New York': crimePatternsImage,
};
      ...
      <div ref={sectionRef} className="mx-auto max-w-7xl">
        ...
        >
          <EditorialSectionHeader
            ...
            eyebrow="Projects"
            title="Projects"
            description="Each project below has a clear structure: what it solves, how it was built, and the outcome."
